...
const Navbar = () => {
  ...
  const handletogglelanguage = (id) => {
    ...
    const languageFiltered = language.filter((item)=>{
      return item.id === id
    })
   
    setFilterLanguage(languageFiltered);
    console.log(changeLanguage);
    // console.log(languageFiltered[0].lang);
  }
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
            <button
              ...
              type="button" data-dropdown-toggle="language-dropdown-menu" className="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
              ...
              <svg className="w-5 h-5 rounded-full me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 3900 3900"><path fill="#b22234" d="M0 0h7410v3900H0z" /><path d="M0 450h7410m0 600H0m0 600h7410m0 600H0m0 600h7410m0 600H0" stroke="#fff" strokeWidth="300" /><path fill="#3c3b6e" d="M0 0h2964v2100H0z" /><g fill="#fff"><g id="d"><g id="c"><g id="e"><g id="b"><path id="a" d="M247 90l70.534 217.082-184.66-134.164h228.253L176.466 307.082z" />
                ...
                {/* {
                changeLanguage ? filterLanguage && filterLanguage[0].flag : language[0].flag
              } */}
                <use xlinkHref="#a" y="420" />
                <use xlinkHref="#a" y="840" />
                <use xlinkHref="#a" y="1260" />
              </g><use xlinkHref="#a" y="1680" /></g><use xlinkHref="#b" x="247" y="210" /></g><use xlinkHref="#c" x="494" /></g><use xlinkHref="#d" x="988" /><use xlinkHref="#c" x="1976" /><use xlinkHref="#e" x="2470" /></g></svg>
              {
                changeLanguage ? filterLanguage && filterLanguage[0].lang : language[0].lang
              }
            ...
            {/* <!-- Dropdown --> */}
            {
              togglelanguage && <div
                ...
                className="z-50 absolute top-[40px] my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown-menu">
                <ul className="py-2 font-medium" role="none">
                  {language && language.map((item) => {
                    return (
                      <li key={item.id} onClick={(e) => handletogglelanguage(item.id)}>
